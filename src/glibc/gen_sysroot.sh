...
imfs_path="$PWD/lind_syscall/imfs.o"
...
object_files="$object_files $lind_syscall_path $register_handler_path $cp_data_path $imfs_path"
...
cp "$PWD/lind_syscall/imfs.h" "$sysroot_dir/include/wasm32-wasi/"
